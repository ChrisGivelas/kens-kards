...
export const SHOPPING_CART_ICON_LARGE = ({ classes }) => (
...
export const SHOPPING_CART_ICON_SMALL = ({ classes }) => (
    <svg className={classes} xmlns="http://www.w3.org/2000/svg" width="20" height="20">
